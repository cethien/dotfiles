...
hl.bind("SUPER + ALT + right", hl.dsp.window.resize({ x = ri, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + ALT + left", hl.dsp.window.resize({ x = -ri, y = 0, relative = true }), { repeating = true })
hl.bind("SUPER + ALT + up", hl.dsp.window.resize({ x = 0, y = -ri, relative = true }), { repeating = true })
hl.bind("SUPER + ALT + down", hl.dsp.window.resize({ x = 0, y = ri, relative = true }), { repeating = true })
